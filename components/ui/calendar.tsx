...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background font-semibold group/calendar p-3 [--cell-size:--spacing(8)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
      ...
      classNames={{
        ...
        week_number: cn(
          "text-[0.8rem] select-none text-muted-foreground font-semibold",
          defaultClassNames.week_number
        ),
        day: cn(
          "relative w-full h-full p-0 text-center text-foreground [&:last-child[data-selected=true]_button]:rounded-r-md group/day aspect-square select-none",
        ...
        today: cn("font-semibold data-[selected=true]:rounded-none", defaultClassNames.today),
        outside: cn(
          "text-muted-foreground/50 aria-selected:text-muted-foreground/50",
          defaultClassNames.outside
        ),
        disabled: cn("text-muted-foreground/30 opacity-50 line-through", defaultClassNames.disabled),
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "data-[range-middle=true]:bg-foreground/50 data-[range-middle=true]:text-foreground data-[range-middle=true]:hover:bg-foreground",
